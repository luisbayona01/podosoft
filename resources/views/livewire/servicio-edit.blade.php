<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">Editar Servicio</h1>
        </div>
        <p class="text-slate-500 text-sm ml-11">Modifica la información del servicio.</p>
    </div>
