                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" wire:model.blur="clinic_name" placeholder="Ej. Clínica Odontológica DentalCare" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.blur="clinic_nit" placeholder="Número de identificación tributaria" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="email" wire:model.blur="clinic_email" placeholder="clinica@email.com" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                            ...
                            <div>
                                ...
                                <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" wire:model.blur="clinic_phone" placeholder="Ej. 3001234567" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.blur="clinic_city" placeholder="Ej. Bogotá" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" wire:model.blur="clinic_address" placeholder="Calle 123 # 45-67, Barrio Centro" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all placeholder:text-gray-400">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" wire:model.blur="admin_name" placeholder="Ej. Juan" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model.blur="admin_apellido" placeholder="Ej. Pérez" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" wire:model.blur="admin_document" placeholder="Solo números" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" wire:model.blur="admin_licencia" placeholder="Registro profesional" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                                ...
                                <div>
                                    ...
                                    <input type="email" wire:model.blur="admin_email" placeholder="admin@email.com" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                                    @error('admin_email') <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Teléfono <span class="text-red-500">*</span></label>
                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '')" wire:model.blur="admin_phone" placeholder="Ej. 3001234567" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4" x-data="{ show: false }">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input :type="show ? 'text' : 'password'" wire:model.blur="admin_password" placeholder="••••••••" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                                ...
                                <div>
                                    ...
                                    <input :type="show ? 'text' : 'password'" wire:model.blur="admin_password_confirmation" placeholder="••••••••" class="block w-full px-4 py-3 rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-all">
                                </div>
                            </div>
                        </div>
                    </div>
