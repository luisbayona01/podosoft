<div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <form wire:submit="save" class="p-6">
            ...
            @if($activeTab === 1)
            <div class="space-y-4">
                <p class="text-sm text-slate-600">Administra los días y horarios de atención del profesional.</p>
                ...
                <p class="text-xs text-slate-500 mt-3">
                    ...
                    Los horarios inactivos o con hora inicio >= hora fin se eliminarán al guardar.
                </p>
            </div>
            @endif
