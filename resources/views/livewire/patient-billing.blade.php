        ...
        <div class="space-y-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('invoices.create') }}?pacienteId={{ $patientId }}" class="px-4 py-2 bg-white border border-indigo-200 text-indigo-600 text-sm font-semibold rounded-lg hover:bg-indigo-50 transition-all flex items-center gap-2" title="Factura independiente (nuevo flujo)">
