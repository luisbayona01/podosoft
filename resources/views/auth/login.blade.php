...
<head>
    ...
    <title>Iniciar Sesión | {{ $tenant->nombre ?? 'PodoSoft' }}</title>
...
<body class="bg-slate-50 font-sans antialiased">
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            <img src="/images/login-splash.png" 
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-10">
                    ...
                    <p class="text-slate-500 mt-3 text-lg">{{ $tenant->nombre ?? 'Acceda a su cuenta de PodoSoft' }}</p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative group" x-data="{ showPassword: false }">
                            ...
                            <input id="password" name="password" :type="showPassword ? 'text' : 'password'" required 
                                    ...
                                    placeholder="••••••••">
                            <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-blue-600 transition-colors">
                ...
                <div class="text-center mt-12">
                    <p class="text-slate-400 text-sm mb-2">
                        &copy; {{ date('Y') }} <span class="font-semibold text-slate-600">{{ $tenant->nombre ?? 'PodoSoft' }}</span>. Todos los derechos reservados.
                    </p>
